        ...
        while(True):
            ...
            if(my_cascade.face_type > 0):
                ...
                if(my_cascade.face_type > 0):
                    ...
                    #pitch_sum, pitch_avg = Exponential_smoothing_filter(face_counter, exp_sm_thres, sf, xr, pitch_sum, pitch_avg)


                    #yaw_sum, yaw_avg = Exponential_smoothing_filter(face_counter, exp_sm_thres, sf, yr, yaw_sum,  yaw_avg)


                    #roll_sum, roll_avg = Exponential_smoothing_filter(face_counter, exp_sm_thres, sf, zr, roll_sum, roll_avg)
